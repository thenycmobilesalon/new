  ...
  try {
    ...
    const welcomeHtml = `
      <div style="font-family: sans-serif; max-width: 500px;">
        <h2 style="color: #1E2A4A;">Welcome to The NYC Mobile Salon</h2>
        <p>Hi ${name},</p>
        <p>You've been added as <strong>${roleLabels[role] || role}</strong> on The NYC Mobile Salon operations platform.</p>
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; margin: 16px 0;">
          <p style="margin: 4px 0;"><strong>Login URL:</strong> <a href="https://www.thenycmobilesalon.com/admin" style="color: #2563eb;">thenycmobilesalon.com/admin</a></p>
    ...
    `
    await sendEmail(email.toLowerCase().trim(), 'Welcome to The NYC Mobile Salon — Your Login Credentials', welcomeHtml).catch(err => console.error('Welcome email failed:', err))
