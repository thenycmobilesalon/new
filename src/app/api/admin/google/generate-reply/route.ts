...
export async function POST(request: Request) {
  ...
  const prompt = `You are the owner of "The NYC Mobile Salon", a professional mobile beauty service in New York City. Write a short, warm reply to this Google review. Be genuine and professional. Keep it under 3 sentences. Don't be overly enthusiastic or use excessive exclamation marks.
