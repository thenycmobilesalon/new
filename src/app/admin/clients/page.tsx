...
export default function ClientsPage() {
  useEffect(() => { document.title = 'Clients | The NYC Mobile Salon' }, []);
  ...
  return (
      <main className="p-3 md:p-6 max-w-[1600px] mx-auto">
        ...
        <div className="text-sm text-gray-400 mb-6">
          Client portal: <a href="https://www.thenycmobilesalon.com/book" target="_blank" className="text-[#1E2A4A]/70 hover:underline py-2 inline-block">thenycmobilesalon.com/book</a> ·
          New booking: <a href="https://www.thenycmobilesalon.com/book/new" target="_blank" className="text-[#1E2A4A]/70 hover:underline ml-1 py-2 inline-block">thenycmobilesalon.com/book/new</a> ·
          Collect info: <a href="https://www.thenycmobilesalon.com/book/collect" target="_blank" className="text-[#1E2A4A]/70 hover:underline ml-1 py-2 inline-block">thenycmobilesalon.com/book/collect</a>
        </div>
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        ...
                        <p className="text-[11px] text-gray-400 mt-0.5">Client uses this PIN + email to log into thenycmobilesalon.com/book</p>
                      </div>
                      <button
                        type="button"
                        onClick={async () => {
