...
export default function DocsPage() {
  useEffect(() => { document.title = 'Documentation | The NYC Mobile Salon' }, [])
  ...
  return (
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 p-3 md:p-6">
        ...
        {s === 'overview' && (
          <div>
            <h1 className="text-3xl font-bold text-[#1E2A4A] mb-2">The NYC Mobile Salon Platform</h1>
            <p className="text-gray-500 mb-6">Complete mobile beauty service management system</p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <Card title="" accent="blue">
                <p><strong>Live:</strong> <a href="https://www.thenycmobilesalon.com" className="underline py-1.5 inline-block">thenycmobilesalon.com</a></p>
                <p><strong>GitHub:</strong> <a href="https://github.com/thenycmobilesalon/nycmobilesalon" className="underline py-1.5 inline-block">thenycmobilesalon/nycmobilesalon</a></p>
              </Card>
              <Card title="" accent="blue">
                <p><strong>Vercel:</strong> <a href="https://vercel.com/jeff-tuckers-projects/nycmobilesalon" className="underline py-1.5 inline-block">jeff-tuckers-projects/nycmobilesalon</a></p>
        ...
        {s === 'platform-map' && (
          <div>
            ...
            <T headers={['Service', 'Purpose', 'Used In']} rows={[
              ['Resend', 'Email delivery (hi@thenycmobilesalon.com)', 'All emails — 21+ templates'],
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li><strong>Delivery</strong> — Emailed to thenycmobilesalon@gmail.com + creates dashboard notification</li>
            </ul>
          </div>
        )}
...
└── lib/                            # 16 utility modules`}
        ...
        {s === 'database' && (
          <div>
            ...
            <p className="text-gray-500 text-sm mb-2">Team members who perform mobile beauty services</p>
            ...
            <p className="text-gray-500 text-sm mb-2">Customers who book mobile beauty services</p>
        ...
        {s === 'emails' && (
          <div>
            ...
            <Card title="" accent="gray">
              <p><strong>Email Provider:</strong> Resend (from: hi@thenycmobilesalon.com)</p>
...
git push origin main`}
            ...
            <T headers={['Service', 'URL']} rows={[
              ['Live Site', 'www.thenycmobilesalon.com'],
              ['Vercel', 'vercel.com/jeff-tuckers-projects/nycmobilesalon'],
              ['GitHub', 'github.com/thenycmobilesalon/nycmobilesalon'],
...
curl -b "admin_authenticated=true" https://www.thenycmobilesalon.com/api/dashboard

# Check build
npm run build 2>&1 | head -50

# Read docs as JSON
curl https://www.thenycmobilesalon.com/api/docs | jq .`}
            </pre>
          </div>
        )}
