...
export default function WebsitesPage() {
  useEffect(() => { document.title = 'Websites | The NYC Mobile Salon' }, []);
  ...
  const loadWebsites = () => {
    const sites: Website[] = [
      ...
      { domain: 'thenycmobilesalon.com', location: 'NYC', region: 'NYC Metro', url: 'https://www.thenycmobilesalon.com', lat: 40.7589, lng: -73.9851 },
      { domain: 'thenycmobilesalonservice.com', location: 'NYC', region: 'NYC Metro', url: 'https://thenycmobilesalonservice.com', lat: 40.7589, lng: -73.9851 },
