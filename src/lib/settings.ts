...
export const DEFAULT_SETTINGS: Omit<Settings, 'id' | 'updated_at'> = {
  ...
  business_email: 'hi@thenycmobilesalon.com',
  business_website: 'https://www.thenycmobilesalon.com',
  admin_email: 'thenycmobilesalon@gmail.com',
  email_from_name: 'The NYC Mobile Salon',
  email_from_address: 'hi@thenycmobilesalon.com',
  service_types: [
    { name: 'Blowouts & Styling', default_hours: 1, active: true },
    { name: 'Haircut', default_hours: 1, active: true },
    { name: 'Color / Highlights', default_hours: 2, active: true },
    { name: 'Silk Press', default_hours: 2, active: true },
    { name: 'Braids & Protective Styles', default_hours: 3, active: true },
    { name: 'Extensions', default_hours: 3, active: true },
    { name: 'Updo & Formal Styling', default_hours: 2, active: true },
    { name: 'Manicure', default_hours: 1, active: true },
    { name: 'Pedicure', default_hours: 1, active: true },
    { name: 'Nail Art / Acrylics', default_hours: 2, active: true },
    { name: 'Makeup', default_hours: 1, active: true },
    { name: 'Facial', default_hours: 1, active: true },
    { name: 'Waxing', default_hours: 1, active: true },
    { name: "Men's Haircut / Fade", default_hours: 1, active: true },
    { name: 'Beard Trim / Shave', default_hours: 1, active: true },
    { name: "Men's Grooming", default_hours: 1, active: true },
    { name: 'Event / Group Booking', default_hours: 3, active: true },
    { name: 'Class / Workshop', default_hours: 2, active: true },
  ],
  standard_rate: 99,
  budget_rate: 89,
